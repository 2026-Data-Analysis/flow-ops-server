...
public record ApiInventoryResponse(
    ...
    private static ApiInventoryEditStatus editStatus(ApiInventory apiInventory) {
        return apiInventory.getSourceType() == ApiInventorySource.OPENAPI
