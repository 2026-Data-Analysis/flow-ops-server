...
public class AiWebClient implements AiClient {
    ...
    @Override
    public IncidentAnalyzeResponse analyzeIncident(IncidentAnalyzeRequest request) {
        return post("/v1/agents/incident/analyze", request, IncidentAnalyzeResponse.class);
    }
